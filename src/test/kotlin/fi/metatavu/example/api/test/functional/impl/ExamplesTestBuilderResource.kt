...
import fi.metatavu.example.api.test.functional.impl.ApiTestBuilderResource
...
import fi.metatavu.oss.test.client.apis.ExamplesApi
...
class ExamplesTestBuilderResource(
     ...
     */
    fun listExamples(firstResult: Int?, maxResults: Int?): Array<fi.metatavu.oss.test.client.models.Example> {
